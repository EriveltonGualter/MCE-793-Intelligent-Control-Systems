function BackPropAlgo(Input, Output)
    ...
    [errorValue delta_V delta_W] = trainNeuralNet(Norm_Input,Norm_Output,W1,W2);
...
%         count
        [errorValue delta_V delta_W]=trainNeuralNet(Norm_Input,Norm_Output,W1,W2,delta_V,delta_W);
        errorValue
    end
